...
public:
    ...
    std::vector<double> true_values_2;
    ...
    MainWork2(double right_border = 1.0, double initial_value = 1.0,double initial_value_2 = 1.0, double initial_step = 0.01, int max_steps = 1000, bool ctrl_local_err = true, double eps = 1e-8);
    double Func1(double u1,double u2);
	double Func2(double u1, double u2);
    double TrueFunc1(double x);
    double TrueFunc2(double x);
